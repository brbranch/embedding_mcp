...
```go
func NewEmbedder(cfg *model.EmbedderConfig, apiKey string, dimUpdater DimUpdater) (Embedder, error)
```
...
| `TestOpenAIEmbedder_Embed_APIError` | API 4xx/5xxエラーで適切なエラー |
...
| `TestNewEmbedder_OpenAI_NoAPIKey` | apiKeyなしでErrAPIKeyRequired |
